...
export default function Hero() {
  return <section className="relative isolate min-h-screen overflow-hidden bg-[#030303] px-6 text-white">
    ...
    <style jsx>{`@keyframes orbit{to{transform:rotate(360deg)}} @keyframes track{to{stroke-dashoffset:-24}}`}</style>
  </section>;
}
