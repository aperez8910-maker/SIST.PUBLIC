      ...
      <section className="command-hero">
        ...
        <div className="hero-visual">
          ...
          <div className="hero-nodes" aria-hidden="true">
            {stages.map(({ n }) => (
              <span key={n} className="hero-node">{n}</span>
            ))}
          </div>
        </div>
...
.command-hero{position:relative;min-height:min(88vw,820px);border-bottom:1px solid rgba(215,173,82,.18);isolation:isolate;display:grid;grid-template-columns:1.1fr 1.6fr .8fr}.hero-content{position:relative;z-index:2;display:flex;flex-direction:column;justify-content:center;padding:clamp(30px,6vw,110px);max-width:720px}.eyebrow,.section-kicker{font-size:9px;font-weight:700;letter-spacing:.36em;color:#d4aa50}.hero-content h1{margin:18px 0 0;font:700 clamp(46px,6.4vw,92px)/.88 Arial,sans-serif;letter-spacing:.02em;text-shadow:0 10px 40px #000}.hero-content h1 em{font-style:normal;color:#d5aa50}.hero-content>p{margin:14px 0;font-size:clamp(18px,2vw,28px);font-weight:700;letter-spacing:.2em}.hero-actions{margin-top:26px;display:flex;flex-wrap:gap:10px}.hero-badge{position:absolute;left:clamp(18px,4vw,64px);bottom:40px;z-index:3;border:1px solid rgba(215,173,82,.42);padding:10px 14px;color:#9d9a91;font-size:7px;letter-spacing:.18em;background:rgba(3,7,8,.7);backdrop-filter:blur(10px)}.hero-badge i,.live-status i{display:inline-block;width:6px;height:6px;border-radius:50%;background:#86ae8c;box-shadow:0 0 12px #86ae8c;margin-right:8px}.hero-badge b{display:block;color:#d6ae55;margin-top:7px}.hero-visual{position:relative;overflow:hidden}.hero-eagle{object-fit:cover;object-position:center}.hero-gradient{position:absolute;inset:0;background:linear-gradient(90deg,rgba(2,3,4,.92) 0%,rgba(2,3,4,.55) 48%,rgba(2,3,4,.12) 100%),linear-gradient(0deg,#020304 0%,transparent 22%,transparent 78%,#020304 100%);z-index:1}.hero-nodes{position:absolute;inset:0;z-index:2;pointer-events:none}.hero-node{position:absolute;width:32px;height:32px;border-radius:50%;border:1px solid rgba(215,173,82,.55);display:grid;place-items:center;font:700 11px Georgia,serif;color:#f0d078;background:radial-gradient(circle,rgba(0,0,0,.65),rgba(2,3,4,.4));box-shadow:0 0 18px rgba(215,173,82,.18)}.hero-node:nth-child(1){top:18%;left:28%}.hero-node:nth-child(2){top:32%;left:50%}.hero-node:nth-child(3){top:22%;left:66%}.hero-node:nth-child(4){top:48%;left:38%}.hero-node:nth-child(5){top:40%;left:62%}.hero-node:nth-child(6){top:56%;left:22%}.hero-node:nth-child(7){top:52%;left:72%}.hero-node:nth-child(8){top:66%;left:46%}.hero-node:nth-child(9){top:70%;left:60%}.hero-side{position:relative;z-index:2;border-left:1px solid rgba(215,173,82,.18);background:rgba(2,3,4,.55);backdrop-filter:blur(14px)}
