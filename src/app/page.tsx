        ...
        <div className="method-track">
          ...
          {stages.map(({ n, title, tag }) => (
            <button key={n} className="method-node" type="button">
              {tag ? <span className="method-tag">{tag}</span> : null}
